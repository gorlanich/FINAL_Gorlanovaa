...
class User {
  ...
  Widget pancakeEater(BuildContext context) {
    return Column(
      children: [
        Container(
          ...
          child: Row(
            children: [
              Expanded(flex: 2, child: Text("Блиноед №:", style: Theme.of(context).textTheme.bodyMedium, textAlign: TextAlign.left)),
              Expanded(flex: 1, child: Text('$id', style: Theme.of(context).textTheme.bodyMedium, textAlign: TextAlign.left)),
              Expanded(flex: 6, child: Text(name, style: Theme.of(context).textTheme.bodyText1, textAlign: TextAlign.left)),
